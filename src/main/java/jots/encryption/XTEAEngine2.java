    ...
    implements BlockCipher
{
    ...
    {
        if (!(params instanceof KeyParameter) && !intKey)
        {
        ...
        int     outOff)
    {
        ...
        {
            v0    += ((v1 << 4 ^ v1 >>> 5) + v1) ^ (sum + _S[sum & 3]) & 0xffffffff;
            sum += delta & 0xffffffff;
            v1    += ((v0 << 4 ^ v0 >>> 5) + v0) ^ (sum + _S[sum >>> 11 & 3]) & 0xffffffff;
        }
